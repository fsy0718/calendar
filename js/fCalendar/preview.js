...
define(function() {
  ...
  weekZh = '日一二三四五六';
  weekReg = /\bday-d(\d)\b/;
  return function(e, cell, view, box, data) {
    var _date, chineseEra, date, day, lunar, lunarDate, preview, thisLunar, week, ymd;
    preview = box.find('.preview-cont');
    week = weekReg.exec(cell.attr('class'));
    ...
    return $.isFunction(view.conf.afterShowPreview) && view.conf.afterShowPreview(preview, cell, box, view);
  };
});
